...
class InventoryManagement {
      ...
      <div class="inventory-management">
        ...
        <div class="inventory-content">
          ...
          <div id="inventory-form-view" class="inventory-view d-none">
            <div class="card">
              <div class="card-header">
                <h4 id="form-title"><i class="fas fa-plus-circle me-2"></i> Adicionar Novo Item</h4>
              </div>
              <div class="card-body">
                    ...
                    <div class="col-lg-4">
                      <div class="mb-3">
                        ...
                        <div class="item-image-container">
                          ...
                          <div class="mt-3">
                            <button type="button" class="btn btn-outline-primary" id="item-image-btn">
          ...
          <div id="inventory-movement-view" class="inventory-view d-none">
            <div class="card">
              <div class="card-header">
                <h4><i class="fas fa-exchange-alt me-2"></i> Registrar Movimentação</h4>
              </div>
              <div class="card-body">
                <form id="movement-form">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        ...
                        <div class="btn-group w-100" role="group">
                          ...
                          <label class="btn btn-outline-success" for="movement-entrada">
                          ...
                          <label class="btn btn-outline-danger" for="movement-saida">
                  ...
                  <div class="d-flex justify-content-end gap-2">
                    <button type="button" class="btn btn-secondary" id="cancel-movement-btn">
                      <i class="fas fa-times me-1"></i> Cancelar
                    </button>
                    <button type="submit" class="btn btn-primary" id="save-movement-btn">
  ...
  addStyles() {
    // Não precisamos mais adicionar estilos aqui, pois agora estamos usando um arquivo CSS separado
  }
      ...
      tableBody.innerHTML = `
        <tr>
          <td colspan="7" class="text-center py-5">
            ...
            <p class="mb-0 fs-5">Nenhum item encontrado no estoque</p>
            <p class="text-muted">Adicione itens clicando no botão "Novo Item"</p>
          </td>
        </tr>
      `;
      return;
    ...
    items.forEach(item => {
      ...
      tableHtml += `
        <tr data-item-id="${item.id}">
          <td>
            <img src="${item.imagem}" alt="${item.nome}" class="table-image" onerror="this.src='https://via.placeholder.com/48?text=Sem+Imagem'">
          </td>
          ...
          <td>
            <div class="action-buttons">
              <button type="button" class="action-btn action-btn-edit edit-item-btn" data-item-id="${item.id}" title="Editar">
                <i class="fas fa-edit"></i>
              </button>
              <button type="button" class="action-btn action-btn-move movement-item-btn" data-item-id="${item.id}" title="Movimentar">
                <i class="fas fa-exchange-alt"></i>
              </button>
              <button type="button" class="action-btn action-btn-delete delete-item-btn" data-item-id="${item.id}" title="Excluir">
